...
export class CardMerchantService {
    ...
    private privateKry = `-----BEGIN PRIVATE KEY-----
    ...
    getSignInit(str:any) :any{
        ...
        let rsa = jsrsasign.KEYUTIL.getKey(this.privateKry);
